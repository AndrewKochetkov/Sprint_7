...
public class CreatingOrderTest extends BaseTest {
    ...
    public static Object[][] getData() {
        return new Object[][]  {
                {"Ichigo", "Kurosaki", "Karakura, 23 apt.", "15", "+7 900 123 45 67", 7, "2025-06-15", "Rukia, let's save the world", new String[]{"GREY", "BLACK"}},
                {"Artem", "Ivanov", "Moscow, 55 apt.", "12", "+7 905 678 90 12", 6, "2025-03-21", "Everything is fine", new String[]{"GREY"}},
                {"Levi", "Ackerman", "Shiganshina, 88/7", "10", "+7 701 123 45 67", 8, "2025-05-12", "Let's move forward", new String[]{"BLACK"}},
                {"Ryuk", "Shinigami", "Tokyo, Shibuya", "5", "+7 702 987 65 43", 9, "2025-08-08", "Apple time", null},
        };
    }
